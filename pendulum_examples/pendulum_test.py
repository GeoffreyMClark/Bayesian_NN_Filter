...
if __name__=='__main__':
    ...
    ctrl_model = tf.saved_model.load('/home/local/ASUAD/gmclark1/Research/data/pendulum_high/models/ctrl0')
    ...
    obs_model = models.load_model('/home/local/ASUAD/gmclark1/Research/data/pendulum_high/models/fullobs1')
